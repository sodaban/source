...
<body>
    ...
    <p>Vous pouvez effectuer les actions suivantes sur les tournois ouverts:</p>
    <ul>
        <li><a href="modifieEtatTournois.php">Modifier l'état des Tournois (ouvert/fermé)</a></li>
    ...
    <ul>
        <li>En cours de construction</li>
    </ul>
